...
<div class="card mt-5 ml-4 mr-5">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="nama_ayah" id="exampleInputEmail1" aria-describedby="emailHelp">
  <div class="form-group">
    <label for="exampleInputPassword1">Tangal Lahir ayah</label>
    <input type="date" class="form-control" name="tanggal_lahir_ayah" id="exampleInputPassword1">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Nama ibu</label>
    <input type="text" class="form-control" name="nama_ibu" id="exampleInputPassword1">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Tangal Lahir ibu</label>
    <input type="date" class="form-control" name="tanggal_lahir_ibu" id="exampleInputPassword1">
  </div>
